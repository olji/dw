...
int read_config(char *homedir){
    /* Set default values */
    CONFIG.default_table = malloc(sizeof(char)*strlen(DEF_TABLE) + 1);
    strcpy(CONFIG.default_table, DEF_TABLE);
    CONFIG.key_length = 5;
    ...
    cfg_opt_t opts[] = {
        ...
        CFG_SIMPLE_STR("default-table", &CONFIG.default_table),
    ...
    CONFIG.table_size = pow(CONFIG.char_set_size, CONFIG.key_length);
